...
function countDown() {
  ...
  if (textDay <= 0 && textHour <= 0 && textMinute <= 0 && textSecond <= 0) {
    ...
    document.querySelector(".sale-time__btn").textContent = "Noel 2021";
...
var api = "http://127.0.0.1:5500/Web%20My%20Sea/fake_api/db.json";
// var api = "http://127.0.0.1:5500/Web%20My%20Sea/fake_api/db.json";
...
// chức năng thả tim đã fix
// window.onload = () => {
//     var test = document.querySelectorAll('.likeBtn')
//   // console.log(test)
